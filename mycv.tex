...
\begin{rSection}{Work Experience}
  ...
  \item
    ...
    \detail{Implemented face detection, automatic alignment and manual alignment with constrains based on the latest face technologies from MSRA research teams;}\\
